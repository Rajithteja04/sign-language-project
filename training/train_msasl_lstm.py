...
from data.adapters.msasl import load_msasl
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train MS-ASL LSTM classifier")
    parser.add_argument("--dataset-root", required=True, help="Path to MS-ASL root containing train/val/test folders.")
    parser.add_argument("--seq-len", type=int, default=30)
    parser.add_argument("--top-k", type=int, default=20, help="Number of most frequent labels to keep (train split).")
    parser.add_argument("--cache-features", action="store_true")
    parser.add_argument("--cache-dir", default="artifacts/cache/msasl_seq30")
    ...
    parser.add_argument("--out-dir", default="artifacts/msasl")
...
def main():
    ...
    tag = (
        f"msasl_top{args.top_k}_seq{args.seq_len}_h{args.hidden_dim}_l{args.layers}"
